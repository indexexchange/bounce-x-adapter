...
var PartnerSpecificValidator = require('bounce-x-htb-validator.js');
...
function BounceXHtb(configs) {
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'BounceXHtb', // PartnerName
            namespace: 'BounceXHtb', // Should be same as partnerName
            statsId: 'BNCX', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
